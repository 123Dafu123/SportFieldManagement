...
public:
    ...
    bool orderField(QString MBRId,QString FId);
    ...
    bool addField(QString FId,QString FName,QString FType,QString FAddr,float FFee);
    QSqlQueryModel* searchFModelbyName(QString FName);
    bool modfiyField(QString modId,QString FName,QString FType,QString FAddr,float FFee);
    bool deleteField(QString FId);
